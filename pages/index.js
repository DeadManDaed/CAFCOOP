  ...
  return (
    <>
      <Head>
        <title>CAFCOOP</title>
        <style>{`
          :root {--primary:#2E7D32;--primary-dark:#1B5E20;--accent:#FFC107;--bg:#F5F7FA;--surface:#FFFFFF;--text:#1A1A1A;--text-secondary:#757575;--danger:#D32F2F;--success:#388E3C;--nav-height:64px;--shadow:0 4px 20px rgba(0,0,0,0.08)}
          *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0;padding:0}
          ...
          .product-stock{font-size:11px;color:var(--success);background:#E8F5E9;padding:2px 8px;border-radius:4px;display:inline-block;margin-top:4px}
